...
const SHADE_FILL_TURNS := 60
const SHADE_STAND_SHARE := 1.0 / 3.0
const SHADE_FILL_EASING := 2.0
const SUN_ELEV_START_DEG := -3.0
const SUN_ELEV_END_DEG := 40.0
const SUN_RISE_EASING := 2.0
const SUN_RAKE_DEG := 56.0
...
const PICKUPS_PER_SEGMENT := 1
const GRACE_CAP := 2
const POWER_DURATION_TURNS := 40

const LETTER_TURNS := 10
const LETTERS_PER_SEGMENT := 1
const LETTER_MIN_COL_GAP := 10
